...
const DetailsCard = ({data}) => {
  return (
    <div className="flex flex-col gap-8 w-full group hover:border
    border-slate-300 rounded-2xl text-slate-900 bg-slate-100 justify-between">
      <div>
        <div className="
          w-full 
          relative 
          ...
          rounded-xl
        ">
          <img src={data.img} alt="details" className="
       ...
       <div>
        <div className="font-rubik text-[16px] font-normal leading-[34px] flex gap-3 ">
          {data.answer}
        </div> 
      </div>
     </div> 
