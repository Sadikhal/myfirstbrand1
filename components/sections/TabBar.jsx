  ...
  return (
    <div>
      <Tabs defaultValue="mission" className='xl:w-[89%] flex flex-col gap-9 items-start'>
        ...
        <TabsContent value="mission" className="font-rubik text-base font-normal leading-[2.125em] pt-12 sm:pt-0 mt-12 sm:mt-0 text-justify">
        ...
        <TabsContent value="passion" className="font-rubik text-base font-normal leading-[2.125em] pt-12 mt-12 sm:mt-0 sm:pt-0 text-justify">
