      ...
      <div className='flex flex-col xl:flex-row xl:justify-between xl:gap-12 gap-9'>
        <div className='flex flex-col gap-12 xl:flex-[0.65]'>
          <div className='flex flex-col gap-8'>
            ...
            <div className='font-rubik text-[16px] font-normal leading-[2.125em] text-justify xl:mt-4 2xl:pt-2'>
            ...
            <div className='xl:flex justify-center mt-6 hidden'>
              <Link href='/about' key='button' className='text-center'>
                <Button className="text-[18px] font-normal leading-[30px] tracking-[0.1em] xl:mt-5 font-teko bg-[#FC8D00] hover:bg-foreground px-[70px] py-[33px] uppercase">
                  know more
                </Button>
              </Link>  
            </div>
