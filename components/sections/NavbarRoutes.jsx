...
const NavbarRoutes = () =>{
  ...
  const routes = [
    ...
    active: pathname === '/service' || pathname.startsWith('/service'),
  },
 ...
 return(
  ...
  {routes?.map((route) => (
    ...
    href={route?.href}  className='text-center font-teko text-[20px] leading-[30px] opacity-1 text-foreground font-[500] uppercase tracking-[.03em] relative group shallow'>
    {route.label === 'Services' ? <Services /> : route.label}  
      <div className={cn ('absolute w-full h-[2px] bg-[#FC8D00] scale-x-0 group-hover:scale-x-100 transition  ease-in-out delay-0 duration-500', route.active && 'scale-x-100')}/>
