  ...
  return (
    <div>
      <div className='w-full flex flex-col justify-center gap-12'>
        <h3 className='text-center font-teko text-[60px]  leading-[0.85em] font-normal uppercase'>Why Choose Mybrandfirst?.</h3>
        <div className='text-left font-rubik text-[16px] font-normal leading-[2.125em] w-full px-3'>
