    ...
    <div className='flex flex-col xl:flex-row gap-8 xl:gap-14 xl:justify-between mt-12 py-5'>
      ...
      <div className='lg:flex-[0.7]'>
        <div className='font-rubik text-base font-normal leading-[2.125em]'>
          ...
          <br/>
          <br/>
          Our suite of services encompasses the full spectrum of digital marketing disciplines,
including search engine optimization (SEO), pay-per-click (PPC) advertising, social
media marketing, content creation, email marketing, and more. Whether you&#39;re
looking to boost your search engine rankings, enhance brand visibility on social
media platforms, or drive qualified leads to your website, we have the expertise and
resources to make it happen.
<br/>
<br/>
So why wait? Let&#39;s embark on this digital journey together and unlock the full
potential of your brand online. Get in touch with us today to schedule a consultation,
and let&#39;s turn your digital aspirations into reality.
        </div>
      </div>
    </div>
  );
