...
const NavbarComponent = () => {
    ...
    >
      ...
      <div className="relative z-10">
       ...
       <div className='flex flex-col justify-center items-center relative px-3 gap-5 h-[70%]'>
        ...
        <h1 className='text-center xl:text-[70px] font-teko xl:leading-[1em] uppercase tracking-[1px] flex flex-wrap font-[600] lg:text-[60px] lg:leading-[1.05em] text-[48px] leading-[1.1em]  text-slate-50  '>
        Digital marketing angency <br/>in Bangalore
      </h1>
        </motion.div>
       <motion.div 
       initial="hidden"
       ...
       className='lg:pt-5 pt-8 '>
       <Link href='/about' key='contact' className='relative z-10 opacity-100 cursor-pointer '>
          <Button className="text-[18px] font-normal leading-[30px] tracking-[0.1em] font-teko bg-[#FC8D00] hover:bg-black hover:text-foreground px-[50px] py-[33px] z-10 uppercase cursor-pointer">
            discover more
          </Button>
        </Link>  
       </motion.div>
 ...
 <motion.div 
   ...
   whileInView="show"
   variants={navVariant}
 className='absolute bottom-0 right-0 w-full overflow-hidden leading-0 z-1'>
